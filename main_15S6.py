...
sample_num_per_class_list = [10,20,40,80-8]
sample_num_per_class_list = [72]
sample_num_per_class_list = [None]
...
data_dir_list_list = [
                    ...
                    [ '15Stanford-origin-9fold',
                      '15Stanford-origin-9fold_noise0p01',],

                    [ '15Stanford-origin-9fold','15Stanford-origin-9fold_mask1-1',],

                    [ '15Stanford-origin-9fold',],

                    # [ '15Stanford-origin-9fold',
                    #   '15Stanford-origin-9fold_noise0p01','15Stanford-origin-9fold_mask1-1',],
                      ]
target_fold_list = [0,1,2,3,4,5,6,7,8,]
fold_num = 9
...
sub_list_list = [['S1'],['S2'],['S3'],['S4'],['S5'],
                 ['S6'],['S7'],['S8'],['S9'],['S10']] # 15S
# sub_list_list = [[fn[0] for fn in sub_list_list]]  # 多被试
# ~ ~ ~ ~ ~ ~
        ...
        for ( learn_rate, train_batch_size , 
            ...
            for sub_list, model_str in result:
                ...
                for foldNO_val in range(fold_num):
                    ...
                    start_time = time.time()
                    train_or_val = 'val'
                    val_data_dir_list = ['15Stanford-origin-9fold']

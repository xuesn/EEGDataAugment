...
data_dir_list_list = [
            ['22_Germany-origin-10fold','22_Germany-origin-10fold_noise0p01-1',]  ,
            ['22_Germany-origin-10fold','22_Germany-origin-10fold_mask1-1',]  ,
            ['22_Germany-origin-10fold',],
            ]
...
for data_dir_list in data_dir_list_list:
    ...
    for sample_num_per_class in sample_num_per_class_list:
        # 
        # 这是train里面concat时的优参  ： 所以要注意train可能要改一下，效果才会好
        lr_list = [ 6e-4, ]
        bs_list = [ 256 ]     # val-bs=512 9044MB  val-bs=800 11132MB  val-bs=21728 MB
        ...
        for ( learn_rate, train_batch_size , 
            ...
            for sub_list, model_str in result:
                ...
                for foldNO_val in range(fold_num):
                    ...
                    start_time = time.time()
                    train_or_val = 'val'
                    val_data_dir_list = ['22_Germany-origin-10fold']
